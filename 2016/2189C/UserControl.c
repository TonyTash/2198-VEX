#pragma config(Sensor, in1,    rArmPot,        sensorPotentiometer)
#pragma config(Sensor, in2,    lArmPot,        sensorPotentiometer)
#pragma config(Motor,  port1,           lArmMotor2,    tmotorVex393, openLoop, reversed)
...
#pragma config(Motor,  port4,           lBackMotor,    tmotorVex393, openLoop)
#pragma config(Motor,  port5,           lFrontMotor,   tmotorVex393, openLoop)
...
#pragma config(Motor,  port10,          rArmMotor2,    tmotorVex393, openLoop, reversed)
...
wait1Msec(200);
  ...
  while ((SensorValue[rArmPot]) > 2100) // up
	...
	// MOVE LESS
	// less drive forward
		while ((SensorValue[rArmPot]) > 1800)
		{
		motor[lArmMotor] = 127;
		motor[rArmMotor] = 127;
		motor[lArmMotor2] = 127;
