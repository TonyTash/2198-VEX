...
void pivotUp(int lPivotSensor, int rPivotSensor, int pivotspeed) // Raise pivot & close claws
{
...
void pivotDown(int lPivotSensor, int rPivotSensor, int pivotspeed)  // Lower pivot & open claws
{
...
int rArm = (SensorValue[rArmPot] + rOffset); // ALSO NEGATES THE POTENTIOMETER
	...
	{
		motor[lArmMotor] = 63; // Raise the arm
		motor[rArmMotor] = 63;
		motor[lArmMotor2] = 63; // Raise the arm
		motor[rArmMotor2] = 63;
