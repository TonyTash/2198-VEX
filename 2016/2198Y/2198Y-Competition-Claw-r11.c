...
wait1Msec(800);
	...
	armHold();
	pivotRest();
	while (SensorValue[rArmPot] > 100) // Raise the arm until the potentiometer reads 1200 (travelling height)
	{
	  armDownNoPot(127);
	  backward();
	}
...
wait1Msec(350);
		...
		while (SensorValue[rArmPot] < 1800) // Raise the arm until the potentiometer reads 1200 (travelling height)
	{
	  ...
	  pivotUp();
		...
		while (SensorValue[rArmPot] < 2200) // Raise the arm until the potentiometer reads 1200 (travelling height)
	{
	  armUpNoPot(127);
	  pivotRest();
	}
