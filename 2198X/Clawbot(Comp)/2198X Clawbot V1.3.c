...
/*
changelog: V1.3: change configuration of rotation
								start to program servo and claw
*/
#pragma platform(VEX)
...
void forwardAuto(int distance)//distance in positive, remember to set sensor value to zero if needed
{
...
void backwardAuto(int distance)//distance in negative, remember to set sensor value to zero if needed
{
	while(SensorValue[leftWheels] > distance || SensorValue[rightWheels] > distance)
	{
		if(SensorValue[leftWheels] > SensorValue[rightWheels])
