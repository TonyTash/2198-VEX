...
/*
v3.0 changelog: update to competition templete, change the larm and rarm value (by the latest starting position)
*/
#pragma platform(VEX)
...
task usercontrol()
{
    ...
    //six bar control.
    if(SensorValue[leftArmSensor] > 567 && SensorValue[rightArmSensor] < 1718 && SensorValue[leftArmSensor] < 2014 && SensorValue[rightArmSensor] > 277)
  	{
    ...
    else if(SensorValue[leftArmSensor] > 2014 || SensorValue[rightArmSensor] < 277)
    {
    	if(vexRT[Btn8U] == 1 && vexRT[Btn8D] == 1)
    	{
    		if(vexRT[Btn5D] == 1)
