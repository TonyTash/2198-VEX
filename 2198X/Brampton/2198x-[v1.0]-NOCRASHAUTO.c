...
task autonomous()
{
  ...
  // .....................................................................................
    ...
    // drive forward to mobile goal and raise cone tower
    ...
    // drive forward to mobile goal and hold the cone
    ...
    // stop driving and clear encoder
		drive(0);
		clearEncoder();
  ...
  //  // drive backward while dropping cone
  ...
  //  // stop moving and clear encoder
  //  drive(0);
  //  clearEncoder();

  //  // drive forward to cross bar
  //  while(SensorValue[rightDrive] < 510)
  //  {
  //      drive(90);
		//		coneTower(0);
		//		coneClaw(0);
  ...
  //  // raise mobile goal to drop the mobile goal
