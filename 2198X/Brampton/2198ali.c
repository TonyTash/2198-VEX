...
{
        if(SensorValue[leftDrive] < SensorValue[rightDriveMotor])
        {
        ...
        else if(SensorValue[leftDrive] > SensorValue[rightDrive])
        {
            ...
            motor[rightDriveMotor] = speed - (abs((SensorValue[leftDrive]) - (SensorValue[rightDrive])));
        }
        else if(SensorValue[leftDrive] == SensorValue[rightDrive])
        {
            motor[frontLeftMotor] = speed;
...
task autonomous()
{
  ...
  // .....................................................................................
    ...
    while(SensorValue[rightDrive] < 340)
    {
        //rotate right motors
...
//    // drive forward until mobile goal
    while(SensorValue[rightDrive] < 1990)
    {
...
//        if(vexRT[Btn7U] == 1)
 ...
 //   }
    ...
    //Claw Motor//
		 ...
		 if(vexRT[Btn8D] == 1)
    {
      motor[coneClawMotor] = 50;
    }
    else if(vexRT[Btn8U] == 1)
    {
      motor[coneClawMotor] = (-1)*(50);
    }
    else
    {
      motor[coneClawMotor] = 15;
    }
