...
void armStop()
{
	if(SensorValue[armSensor] < 1790 && SensorValue[armSensor] > 100)
	{
		motor[leftTower] = 15;
		motor[rightTower] = 15;
	}
...
task autonomous()
{
	...
	armStop();
	while(SensorValue[leftWheels] < 30 && SensorValue[rightWheels] < 30)
	{
		forwardAuto(90);
	}
	stopMoving();
